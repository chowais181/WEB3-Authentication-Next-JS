(function (global, factory) {
  ...
  const useQueryClient = ({
    ...
    const queryClient = React__default["default"].useContext(getQueryClientContext(context, React__default["default"].useContext(QueryClientSharingContext)));
  ...
  const QueryErrorResetBoundaryContext = /*#__PURE__*/React__default["default"].createContext(createValue()); // HOOK

  const useQueryErrorResetBoundary = () => React__default["default"].useContext(QueryErrorResetBoundaryContext); // COMPONENT

  const QueryErrorResetBoundary = ({
    children
  }) => {
    const [value] = React__default["default"].useState(() => createValue());
  ...
  function useIsFetching(arg1, arg2, arg3) {
    ...
    return useSyncExternalStore(React__default["default"].useCallback(onStoreChange => queryCache.subscribe(notifyManager.batchCalls(onStoreChange)), [queryCache]), () => queryClient.isFetching(filters), () => queryClient.isFetching(filters));
  }
  ...
  function useIsMutating(arg1, arg2, arg3) {
    ...
    const queryCache = queryClient.getQueryCache();
    return useSyncExternalStore(React__default["default"].useCallback(onStoreChange => queryCache.subscribe(notifyManager.batchCalls(onStoreChange)), [queryCache]), () => queryClient.isMutating(filters), () => queryClient.isMutating(filters));
  }
  ...
  function useMutation(arg1, arg2, arg3) {
    ...
    const [observer] = React__default["default"].useState(() => new MutationObserver(queryClient, options));
    React__default["default"].useEffect(() => {
      observer.setOptions(options);
    }, [observer, options]);
    const result = useSyncExternalStore(React__default["default"].useCallback(onStoreChange => observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
    const mutate = React__default["default"].useCallback((variables, mutateOptions) => {
  ...
  const useIsRestoring = () => React__default["default"].useContext(IsRestoringContext);
  ...
  function useBaseQuery(options, Observer) {
    ...
    const [observer] = React__default["default"].useState(() => new Observer(queryClient, defaultedOptions));
    const result = observer.getOptimisticResult(defaultedOptions);
    useSyncExternalStore(React__default["default"].useCallback(onStoreChange => isRestoring ? () => undefined : observer.subscribe(notifyManager.batchCalls(onStoreChange)), [observer, isRestoring]), () => observer.getCurrentResult(), () => observer.getCurrentResult());
    React__default["default"].useEffect(() => {
  ...
  function useQueries({
    ...
    const isRestoring = useIsRestoring();
    const defaultedQueries = React__default["default"].useMemo(() => queries.map(options => {
      const defaultedOptions = queryClient.defaultQueryOptions(options); // Make sure the results are already in fetching state before subscribing or updating options

      defaultedOptions._optimisticResults = isRestoring ? 'isRestoring' : 'optimistic';
      return defaultedOptions;
    }), [queries, queryClient, isRestoring]);
    const [observer] = React__default["default"].useState(() => new QueriesObserver(queryClient, defaultedQueries));
  ...
  function useHydrate(state, options = {}) {
    ...
    const optionsRef = React__default["default"].useRef(options);
